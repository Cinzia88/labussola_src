    ...
    <div class="login-logo">
        <div class="login-logo">
            <a href="<?php echo e(route('admin.home')); ?>">
                <img width="100%" src="<?php echo e(url('/images/Logo-LaBussola-1-1024x395.png')); ?>" class="logo" alt="La Bussola Srl">
            </a>
        </div>
    </div>
    <div class="card">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pasqu\Documents\App\labussola_src\resources\views/auth/login.blade.php ENDPATH**/ ?>