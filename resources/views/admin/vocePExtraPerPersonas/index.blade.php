...
@section('content')
@can('voce_p_extra_per_persona_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.voce-p-extra-per-personas.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.vocePExtraPerPersona.title_singular') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
        {{ trans('cruds.vocePExtraPerPersona.title_singular') }} {{ trans('global.list') }}
    </div>

    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-VocePExtraPerPersona">
            <thead>
                <tr>
                    <th width="10">
...
@can('voce_p_extra_per_persona_delete')
  let deleteButtonTrans = '{{ trans('global.datatables.delete') }}';
  let deleteButton = {
    text: deleteButtonTrans,
    url: "{{ route('admin.voce-p-extra-per-personas.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.voce-p-extra-per-personas.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-VocePExtraPerPersona').DataTable(dtOverrideGlobals);
