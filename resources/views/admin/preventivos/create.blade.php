...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.preventivos.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input required class="form-control {{ $errors->has('oggetto') ? 'is-invalid' : '' }}"
                                type="text" name="oggetto" id="oggetto" value="{{ old('oggetto', '') }}">
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('tag_id') ? 'is-invalid' : '' }}"
                                   type="text" name="tag_id" id="tag_id" value="{{ old('tag_id', '') }}">
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('numero_persone') ? 'is-invalid' : '' }}"
                                type="number" name="numero_persone" id="numero_persone"
                                value="{{ old('numero_persone', '1') }}" min="0" step="1" required>
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('prezzo_per_persona') ? 'is-invalid' : '' }}"
                                ...
                                value="{{ old('prezzo_per_persona', '1') }}" min="0" step="1" required>
                            @if ($errors->has('prezzo_per_persona'))
                                <span class="text-danger">{{ $errors->first('prezzo_per_persona') }}</span>
                            @endif
                            <span class="help-block">Prezzo per persona</span>
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('numero_gratuita') ? 'is-invalid' : '' }}"
                                ...
                                value="{{ old('numero_gratuita', '0') }}" step="1" required>
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('markup') ? 'is-invalid' : '' }}" type="number"
                                   name="markup" id="markup" value="{{ old('markup', '0') }}" step="0.01" required>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('data_inzio_viaggio') }}" required>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('data_fine_viaggio') }}" required>
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckEditorCustom {{ $errors->has('corpo_email') ? 'is-invalid' : '' }}"
                                name="corpo_email" id="corpo_email">{!! old('corpo_email') !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor {{ $errors->has('informazioni_aggiuntive') ? 'is-invalid' : '' }}"
                                name="informazioni_aggiuntive" id="informazioni_aggiuntive">*Attenzione: tutte le tariffe proposte, essendo
                                contingentate, sono soggette a disponibilità e
                                riconferma all’atto della conferma del preventivo.</textarea>
                                                                            ...
                                                                            <div class="card-body">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-4">
                                                                                        <div class="form-group">
                                                                                            <label class="required"
                                                                                                for="costo_a_notte">{{ trans('cruds.vocePHotelPerNotte.fields.costo_a_notte') }}</label>
                                                                                            <input class="form-control"
                                                                                                type="number"
                                                                                                name="costo_a_notte"
                                                                                                id="costo_a_notte"
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                value="{{ old('luogo_di_partenza_andata', '') }}">
                                            @if ($errors->has('luogo_di_partenza_andata'))
                                                <span
                                                    class="text-danger">{{ $errors->first('luogo_di_partenza_andata') }}</span>
                                            @endif
                                            <span
                                                class="help-block">{{ trans('cruds.preventivo.fields.luogo_di_partenza_andata_helper') }}</span>
                                        </div>
                                        <div class="form-group">
                                            <label
                                            ...
                                            <input
                                                ...
                                                value="{{ old('luogo_di_arrivo_andata', '') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                value="{{ old('data_ora_partenza_andata') }}">
                                        ...
                                        <div class="form-group">
                                            <label for="data_ora_rientro_andata">Data Ora Arrivo Andata</label>
                                            <input
                                                ...
                                                value="{{ old('data_ora_rientro_andata') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                value="{{ old('kg_bg_a_mano_andata', '') }}" step="1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                value="{{ old('kg_bg_in_stiva_andata', '') }}" step="1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="andata_azienda_trasporto_id"
                                                id="andata_azienda_trasporto_id">
                                                @foreach ($andata_azienda_trasportos as $id => $entry)
                                                    <option value="{{ $id }}"
                                                        {{ old('andata_azienda_trasporto_id') == $id ? 'selected' : '' }}>
                                                        {{ $entry }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                value="{{ old('luogo_di_partenza_rientro', '') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                value="{{ old('luogo_di_arrivo_rientro', '') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                value="{{ old('data_ora_partenza_rientro') }}">
                                        ...
                                        <div class="form-group">
                                            <label for="data_ora_rientro_rientro">Data Ora Arrivo Rientro</label>
                                            <input
                                                ...
                                                value="{{ old('data_ora_rientro_rientro') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                value="{{ old('kg_bg_a_mano_ritorno', '') }}" step="1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                value="{{ old('kg_bg_in_stiva_ritorno', '') }}" step="1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="ritorno_azienda_trasporto_id"
                                                id="ritorno_azienda_trasporto_id">
                                                @foreach ($ritorno_azienda_trasportos as $id => $entry)
                                                    <option value="{{ $id }}"
                                                        {{ old('ritorno_azienda_trasporto_id') == $id ? 'selected' : '' }}>
                                                        {{ $entry }}</option>
                                                @endforeach
                                            </select>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#repeater_trasporto_costo_a_persona').repeater({
                initEmpty: false,
            ...
            $('#repeater_trasporto_costo_una_tantum').repeater({
                initEmpty: false,
            ...
            $('#repeater_serviziextra_costo_una_tantum').repeater({
                initEmpty: false,
            ...
            $('#repeater_serviziextra_costo_a_persona').repeater({
                initEmpty: false,
            ...
            $('#repeater_stanza_costo_a_notte').find('[data-repeater-delete]').click();
            $('#repeater_trasporto_costo_a_persona').find('[data-repeater-delete]').click();
            $('#repeater_trasporto_costo_una_tantum').find('[data-repeater-delete]').click();
            $('#repeater_serviziextra_costo_una_tantum').find('[data-repeater-delete]').click();
            $('#repeater_serviziextra_costo_a_persona').find('[data-repeater-delete]').click();

        });
    </script>
    <script>
        var uploadedFileFornitoreTrasportoMap = {}
        Dropzone.options.fileFornitoreTrasportoDropzone = {
            ...
            success: function(file, response) {
                $('form').append('<input type="hidden" name="file_fornitore_trasporto[]" value="' + response.name +
                    '">')
            ...
            removedfile: function(file) {
                ...
                $('form').find('input[name="file_fornitore_trasporto[]"][value="' + name + '"]').remove()
            },
            init: function() {
                @if (isset($preventivo) && $preventivo->file_fornitore_trasporto)
                    ...
                    for (var i in files) {
                        ...
                        $('form').append('<input type="hidden" name="file_fornitore_trasporto[]" value="' + file
                            .file_name + '">')
                    }
                @endif
            },
    ...
    <script>
        ...
        Dropzone.options.fileFornitoreServiziExtraDropzone = {
            url: '{{ route('admin.preventivos.storeMedia') }}',
            maxFilesize: 80, // MB
            addRemoveLinks: true,
            headers: {
            ...
            success: function(file, response) {
                $('form').append('<input type="hidden" name="file_fornitore_servizi_extra[]" value="' + response
                    .name + '">')
            ...
            removedfile: function(file) {
                ...
                $('form').find('input[name="file_fornitore_servizi_extra[]"][value="' + name + '"]').remove()
            },
            init: function() {
                @if (isset($preventivo) && $preventivo->file_fornitore_servizi_extra)
                    ...
                    for (var i in files) {
                        ...
                        this.options.addedfile.call(this, file)
                        file.previewElement.classList.add('dz-complete')
                        $('form').append('<input type="hidden" name="file_fornitore_servizi_extra[]" value="' + file
                            .file_name + '">')
                    }
                @endif
            },
    ...
    <script>
        ...
        Dropzone.options.fileFornitoreHotelDropzone = {
            url: '{{ route('admin.preventivos.storeMedia') }}',
            maxFilesize: 80, // MB
            addRemoveLinks: true,
            headers: {
            ...
            success: function(file, response) {
                $('form').append('<input type="hidden" name="file_fornitore_hotel[]" value="' + response.name +
                    '">')
            ...
            removedfile: function(file) {
                ...
                $('form').find('input[name="file_fornitore_hotel[]"][value="' + name + '"]').remove()
            },
            init: function() {
                @if (isset($preventivo) && $preventivo->file_fornitore_hotel)
                    ...
                    for (var i in files) {
                        ...
                        this.options.addedfile.call(this, file)
                        file.previewElement.classList.add('dz-complete')
                        $('form').append('<input type="hidden" name="file_fornitore_hotel[]" value="' + file
                            .file_name + '">')
                    }
                @endif
            },
    ...
    <script>
        ...
        Dropzone.options.filesPraticaDropzone = {
            url: '{{ route('admin.preventivos.storeMedia') }}',
            maxFilesize: 50, // MB
            addRemoveLinks: true,
            headers: {
            ...
            success: function(file, response) {
                $('form').append('<input type="hidden" name="files_pratica[]" value="' + response.name + '">')
            ...
            removedfile: function(file) {
                ...
                $('form').find('input[name="files_pratica[]"][value="' + name + '"]').remove()
            },
            init: function() {
                @if (isset($preventivo) && $preventivo->files_pratica)
                    ...
                    for (var i in files) {
                        ...
                        this.options.addedfile.call(this, file)
                        file.previewElement.classList.add('dz-complete')
                        $('form').append('<input type="hidden" name="files_pratica[]" value="' + file.file_name +
                            '">')
                    }
                @endif
            },
