...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.clienti.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.clientis.update", [$clienti->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="nome">{{ trans('cruds.clienti.fields.nome') }}</label>
                <input class="form-control {{ $errors->has('nome') ? 'is-invalid' : '' }}" type="text" name="nome" id="nome" value="{{ old('nome', $clienti->nome) }}" required>
                @if($errors->has('nome'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cognome') ? 'is-invalid' : '' }}" type="text" name="cognome" id="cognome" value="{{ old('cognome', $clienti->cognome) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ragione_sociale') ? 'is-invalid' : '' }}" type="text" name="ragione_sociale" id="ragione_sociale" value="{{ old('ragione_sociale', $clienti->ragione_sociale) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('piva_cf') ? 'is-invalid' : '' }}" type="text" name="piva_cf" id="piva_cf" value="{{ old('piva_cf', $clienti->piva_cf) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('indirizzo') ? 'is-invalid' : '' }}" type="text" name="indirizzo" id="indirizzo" value="{{ old('indirizzo', $clienti->indirizzo) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('citta') ? 'is-invalid' : '' }}" type="text" name="citta" id="citta" value="{{ old('citta', $clienti->citta) }}">
                @if($errors->has('citta'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cap') ? 'is-invalid' : '' }}" type="text" name="cap" id="cap" value="{{ old('cap', $clienti->cap) }}">
                @if($errors->has('cap'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('provincia') ? 'is-invalid' : '' }}" type="text" name="provincia" id="provincia" value="{{ old('provincia', $clienti->provincia) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('stato') ? 'is-invalid' : '' }}" type="text" name="stato" id="stato" value="{{ old('stato', $clienti->stato) }}">
                @if($errors->has('stato'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $clienti->email) }}">
                @if($errors->has('email'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telefono') ? 'is-invalid' : '' }}" type="text" name="telefono" id="telefono" value="{{ old('telefono', $clienti->telefono) }}">
