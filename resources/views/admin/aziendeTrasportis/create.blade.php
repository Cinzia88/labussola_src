...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.aziendeTrasporti.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.aziende-trasportis.store") }}" enctype="multipart/form-data">
            @csrf
