    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-createdByPreventivos">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.preventivo.fields.viewkey') }}
                            </th>
                            <th>
                            ...
                            <th>
                                {{ trans('cruds.preventivo.fields.kg_bg_a_mano_andata') }}
                            </th>
                            <th>
                                {{ trans('cruds.preventivo.fields.kg_bg_a_mano_ritorno') }}
                            </th>
                            <th>
                                {{ trans('cruds.preventivo.fields.kg_bg_in_stiva_andata') }}
                            </th>
                            <th>
                                {{ trans('cruds.preventivo.fields.kg_bg_in_stiva_ritorno') }}
                            </th>
                            <th>
...
@endcan
  ...
  let table = $('.datatable-createdByPreventivos:not(.ajaxTable)').DataTable({ buttons: dtButtons })
